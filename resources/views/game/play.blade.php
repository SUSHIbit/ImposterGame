...
@section('game-nav')
<form method="POST" action="{{ route('room.leave', $room->code) }}" class="inline">
    @csrf
    <button type="submit" class="bg-red-600 hover:bg-red-500 text-white px-3 py-1 rounded text-sm" onclick="return confirm('Are you sure you want to leave the game?')">
        Leave Game
    </button>
</form>
@endsection
